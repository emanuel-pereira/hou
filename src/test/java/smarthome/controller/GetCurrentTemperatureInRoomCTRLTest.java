...
class GetCurrentTemperatureInRoomCTRLTest {
    ...
    void getCurrentTempOfaRoom() {
        ...
        GetCurrentTemperatureInRoomCTRL ctr2 = new GetCurrentTemperatureInRoomCTRL(h1,sL);
    ...
    public void checkIfSensorTypeExists() {
        ...
        GetCurrentTemperatureInRoomCTRL ctr2 = new GetCurrentTemperatureInRoomCTRL(h,sL);
