...
public class GetTotalRainfallForDayInHouseAreaCTRLTest {
    ...
    void requestReadingRainfall() {
        ...
        Sensor s0 = new ExternalSensor("W2501",new Name("WindSensor2"), startDate, l1, wind, "c", readingList2);
        Location l2= new Location(80, 50, 10);
        Sensor s1 = new ExternalSensor("W2502",new Name("WindSensor1"), startDate,l2 , wind, "c", readingList1);
        Sensor s2 = new ExternalSensor("W2503",new Name("WindSensor3"), startDate, l2, wind, "c", readingList2);
        Location l3= new Location(1.5, 1.5, 1.5);
        Sensor s3 = new ExternalSensor("T2501",new Name("TemperatureSensor"), startDate, l3, temperature, "c", readingList2);
    ...
    void closestSensorsWithReadingsInDate() {
        ...
        Sensor s0 = new ExternalSensor("R0001",new Name("RainfallSensor2"), startDate,l1, rainfall, "c", readingList2);
        Sensor s1 = new ExternalSensor("R0002",new Name("RainfallSensor1"), startDate, l2, rainfall, "c", readingList1);
        Sensor s2 = new ExternalSensor("W0001",new Name("WindSensor3"), startDate,l2, rainfall, "c", readingList2);
        Sensor s3 = new ExternalSensor("T0001",new Name("TemperatureSensor"), startDate, l3, temperature, "c", readingList2);
