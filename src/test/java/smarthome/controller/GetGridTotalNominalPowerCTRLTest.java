...
class GetGridTotalNominalPowerCTRLTest {
    ...
    void getHouseGridListSize() {
        ...
        GetGridTotalNominalPowerCTRL US172CTRL = new GetGridTotalNominalPowerCTRL(house);
    ...
    void getTotalNominalPowerInGridIfCorrect() {
        ...
        GetGridTotalNominalPowerCTRL US172CTRL = new GetGridTotalNominalPowerCTRL(h);
