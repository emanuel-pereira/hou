...
class SensorListTest {
    ...
    @DisplayName("Tests if a Sensor is not added to the lit if the list already contains that sensor")
    @Test
    ...
    @DisplayName("Tests if a Sensor is  added to the lit if the list")
    @Test
