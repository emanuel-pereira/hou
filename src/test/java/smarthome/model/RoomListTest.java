...
public class RoomListTest {
    ...
    public void getDeviceLocationTest(){
        ...
        rList.get(0).getDeviceList().addDevice(d1);
        rList.get(0).getDeviceList().addDevice(d2);
        rList.get(1).getDeviceList().addDevice(d5);

        Room expectedResult = r3;
        Room result = rList.getDeviceLocation(d5);
        assertEquals(expectedResult,result);
    }

    @Test
    public void getDeviceLocationTestNotEquals(){
        RoomList rList = new RoomList();
