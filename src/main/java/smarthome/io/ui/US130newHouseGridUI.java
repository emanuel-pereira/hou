...
public class US130newHouseGridUI {
     ...
     */
    public void run() {
        //call the method that checks and prints the GA's List in order to select a house
        //present the list of houses in order to select a house
        //ask for the maximum power of the new grid for that house
        ...
        if (mCtrlUS130.createNewHouseGrid(inputMaxPower, mHouse))
            System.out.println("Created a new House Grid set with " + inputMaxPower + " kVA of Maximum Power for the house");
    }
}