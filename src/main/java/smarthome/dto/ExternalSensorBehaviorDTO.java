...
public class ExternalSensorBehaviorDTO {
    ...
    public ExternalSensorBehaviorDTO(){}

    public ExternalSensorBehaviorDTO(GenericNameDTO sensorName, Calendar startDate, SensorTypeDTO sensorType, String unit, List<ExternalReadingDTO> readings) {
