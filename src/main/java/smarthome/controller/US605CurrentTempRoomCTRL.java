...
public class US605CurrentTempRoomCTRL {
    ...
    public boolean checkIfRoomListNotEmpty(){
        return mRoomList.checkIfRoomLisNotEmpty ();
    }

    public boolean checkIfSensorTypeExistInRoom(String type) {
        return mRoomList.checkIfSensorTypeExistsInRoom (type);
    }
